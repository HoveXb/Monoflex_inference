...
_C.SOLVER.DECAY_EPOCH_STEPS = [80, 90] # steps in epochs
...
_C.SOLVER.EVAL_INTERVAL = 1000
_C.SOLVER.SAVE_CHECKPOINT_EPOCH_INTERVAL = 2
...
_C.TEST.UNCERTAINTY_AS_CONFIDENCE = True
...
_C.TEST.VISUALIZE_THRESHOLD = 0.25
...
_C.IFERENCE = CN()
# List of the dataset names for training, as present in paths_catalog.py
_C.IFERENCE.ROOT = "/home/hovexb/HSJ/kitti_raw_0095/training2"
